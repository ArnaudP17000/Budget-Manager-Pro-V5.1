...
class BudgetV5View(QWidget):
    ...
    def _build_tab_applications(self):
        ...
        self.tbl_apps.itemSelectionChanged.connect(
            lambda: self.btn_edit_app.setEnabled(self.tbl_apps.currentRow() >= 0))
    ...
    def _export_excel(self):
        ...
        if ok:
            QMessageBox.information(self, "Export réussi",
                ...
                "4 onglets : Synthèse, Lignes budgétaires, Contrats, BC")
        else:
