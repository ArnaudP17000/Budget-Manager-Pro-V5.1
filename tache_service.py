...
class TacheService:
    ...
    def create(self, data):
        ...
        try:
            ...
            # Supprimer 'id' — AUTOINCREMENT, ne pas l'insérer
            data.pop('id', None)

            # Nettoyer les dates vides → None
            for date_col in ('date_echeance', 'date_debut', 'date_fin_prevue', 'date_fin_reelle'):
                if date_col in data and not data[date_col]:
                    data[date_col] = None
